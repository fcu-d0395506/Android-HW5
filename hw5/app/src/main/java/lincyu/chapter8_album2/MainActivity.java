...
public class MainActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		albumlist.add(new AlbumItem("馬刺 103",R.drawable.spurs));
		albumlist.add(new AlbumItem("灰熊 96",R.drawable.mem));
		albumlist.add(new AlbumItem(" ", R.drawable.abc_ab_share_pack_holo_dark));
		albumlist.add(new AlbumItem("公鹿 89",R.drawable.bucks));
		albumlist.add(new AlbumItem("暴龍 92",R.drawable.rap));
